...
describe('DocSearch', () => {
  ...
  describe('constructor', () => {
    ...
    beforeEach(() => {
      ...
      sinon.spy(BlogSearch, 'checkArguments');
      sinon.stub(BlogSearch, 'getInputFromSelector').returns(true);

      BlogSearch.__Rewire__('algoliasearch', AlgoliaSearch);
      BlogSearch.__Rewire__('autocomplete', AutoComplete);
    });

    afterEach(() => {
      BlogSearch.checkArguments.restore();
      BlogSearch.getInputFromSelector.restore();
      BlogSearch.__ResetDependency__('algoliasearch');
      BlogSearch.__ResetDependency__('autocomplete');
    });
    ...
    it('should call checkArguments', () => {
      ...
      // Then
      expect(BlogSearch.checkArguments.calledOnce).toBe(true);
    });
    ...
    it('should pass the input element as an instance property', () => {
      // Given
      const options = defaultOptions;
      BlogSearch.getInputFromSelector.returns($('<span>foo</span>'));
    ...
    it('should instantiate autocomplete.js', () => {
      ...
      BlogSearch.getInputFromSelector.returns($input);
  ...
  describe('checkArguments', () => {
    ...
    afterEach(() => {
      if (BlogSearch.getInputFromSelector.restore) {
        BlogSearch.getInputFromSelector.restore();
      }
    });
    ...
    it('should throw an error if no selector matches', () => {
      ...
      sinon.stub(BlogSearch, 'getInputFromSelector').returns(false);
  ...
  describe('handleSelected', () => {
    it('should change the location if no handleSelected specified', () => {
      ...
      // When
      const ds = new BlogSearch(options);
    ...
    describe('default handleSelected', () => {
      it('enterKey: should change the page', () => {
        ...
        new BlogSearch(options).handleSelected(
          mockInput,
          undefined, // Event
          mockSuggestion,
          undefined, // Dataset
  ...
  describe('formatHits', () => {
    it('should not mutate the input', () => {
      ...
      // When
      const actual = BlogSearch.formatHits(input);
  ...
  describe('formatUrl', () => {
    it('concatenates url and anchor', () => {
      ...
      // When
      const actual = BlogSearch.formatURL(input);
  ...
  describe('getSuggestionTemplate', () => {
    beforeEach(() => {
      ...
      BlogSearch.__Rewire__('templates', templates);
    });
    afterEach(() => {
      BlogSearch.__ResetDependency__('templates');
    });
    ...
    describe('returned function', () => {
      ...
      beforeEach(() => {
        ...
        BlogSearch.__Rewire__('Hogan', Hogan);
      });
